(function () {
    ...
    var pageTranslations = {
        ...
        'nhà cà phê. — khách hàng': 'nhà cà phê. — customers',
        ...
        'Thông tin khách': 'Customer details',
        'Cộng điểm': 'Add points',
        'Tặng voucher': 'Gift voucher',
        'Xoá khách': 'Delete customer',
    ...
    function roleNavigation(role) {
        ...
        if (role === 'manager') {
            return [
                ...
                navLink('customers.jsp', tr('navCustomers')),
