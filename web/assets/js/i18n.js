...
const dict = {
    vi: {
        ...
        staffIdLabel: 'Mã nhân viên (hệ thống cấp)', staffNameLabel: 'Tên nhân viên', actions: 'Thao tác',
        ...
        deleteStaffConfirm: 'Xoá nhân viên này?\n\n• Chưa có dữ liệu làm việc nào → hồ sơ và tài khoản bị xoá vĩnh viễn.\n• Đã có lịch sử → hồ sơ được giữ để không mất bảng công, nhưng tài khoản đăng nhập bị gỡ và trạng thái chuyển sang Đã nghỉ.',
        staffPurged: 'Đã xoá vĩnh viễn {name}: người này chưa có dữ liệu làm việc nào.',
        staffDeactivated: '{name} đã chuyển sang trạng thái Đã nghỉ.\n\nHồ sơ được giữ lại vì còn {refs}.',
        accountDeletedNote: 'Tài khoản đăng nhập đã bị xoá khỏi hệ thống.',
        accountLockedNote: 'Tài khoản đăng nhập đã bị khoá và xoá mã PIN. Không xoá hẳn được vì còn hoá đơn ghi tên tài khoản này — xoá đi là mất dấu ai thu tiền.',
        refShifts: 'ca làm', refPayments: 'giao dịch thanh toán', refCashEvents: 'bút toán sổ quỹ',
        refRefunds: 'lần hoàn tiền', refLogs: 'dòng nhật ký', refUnknown: 'dữ liệu liên quan',
        showResigned: 'Hiện cả người đã nghỉ', showResignedCount: 'Hiện cả người đã nghỉ ({count})',
        staffCreatedWithId: 'Đã thêm {name}. Hệ thống cấp mã nhân viên #{id}.',
        staffNameRequired: 'Chưa nhập tên nhân viên.',
        noActiveStaff: 'Không có nhân viên đang làm việc. Bỏ chọn ô lọc để xem người đã nghỉ.',
        ...
        overrideHint: 'Người này đang ngoài giờ ca. Quản lý nhập PIN để mở khoá.',
        offShiftBlocked: 'Bạn đang ngoài giờ ca của mình.',
        resetPin: 'Đặt lại PIN', pinResetDone: 'PIN mới là {pin}',
        noAccountYet: 'Chưa có tài khoản', nextShiftOn: 'Ca gần nhất: {date}',
        shiftLaterToday: 'Chưa tới giờ · {shift}',
        onDutyNow: 'Đang trong ca', offDutyGroup: 'Ngoài ca', notYet: 'Chưa tới giờ',
        shiftEnded: 'Hết ca', shiftEndedHint: 'Ca hôm nay đã kết thúc', noShiftChip: 'Không có ca',
        noAccountShort: 'Quản lý cần tạo tài khoản trước',
        searchStaff: 'Tìm tên…', noMatch: 'Không có tên nào khớp',
    ...
    en: {
        ...
        staffIdLabel: 'Staff ID (assigned by the system)', staffNameLabel: 'Staff name', actions: 'Actions',
        ...
        deleteStaffConfirm: 'Delete this staff member?\n\n• No work records yet → the profile and account are deleted permanently.\n• Has history → the profile is kept so payroll stays intact, but the login account is removed and the status becomes Inactive.',
        staffPurged: 'Permanently deleted {name}: this person had no work records.',
        staffDeactivated: '{name} is now marked as Inactive.\n\nThe profile is kept because of {refs}.',
        accountDeletedNote: 'The login account has been deleted from the system.',
        accountLockedNote: 'The login account was locked and its PIN erased. It could not be deleted outright because receipts still carry this account name — removing it would lose track of who took the money.',
        refShifts: 'shift(s)', refPayments: 'payment(s)', refCashEvents: 'cash ledger entries',
        refRefunds: 'refund(s)', refLogs: 'log line(s)', refUnknown: 'related records',
        showResigned: 'Show former staff', showResignedCount: 'Show former staff ({count})',
        staffCreatedWithId: 'Added {name}. The system assigned staff id #{id}.',
        staffNameRequired: 'Please enter the staff name.',
        noActiveStaff: 'No active staff. Untick the filter to see former staff.',
        ...
        overrideHint: 'This person is outside their shift hours. A manager PIN unlocks sign-in.',
        offShiftBlocked: 'You are outside your shift hours.',
        resetPin: 'Reset PIN', pinResetDone: 'New PIN is {pin}',
        noAccountYet: 'No account yet', nextShiftOn: 'Next shift: {date}',
        shiftLaterToday: 'Not started yet · {shift}',
        onDutyNow: 'On shift now', offDutyGroup: 'Not on shift', notYet: 'Not yet',
        shiftEnded: 'Shift over', shiftEndedHint: 'Today\'s shift has ended', noShiftChip: 'No shift',
        noAccountShort: 'A manager must create the account first',
        searchStaff: 'Search name…', noMatch: 'No matching name',
