...
<div class="max-w-md w-full mx-auto bg-white border border-coffee-sand rounded-3xl p-8 shadow-sm space-y-6 my-12 animate-fade-in">
    ...
    <form onsubmit="return handleMockLogin(event)" class="space-y-4">
        <div class="space-y-1">
            ...
            <input type="text" id="username" value="waiter1" placeholder="Nhập admin, waiter1 hoặc barista1..." required class="w-full text-xs px-4 py-2.5 bg-coffee-light border border-coffee-sand rounded-xl focus:outline-none focus:border-coffee-rust focus:bg-white transition-all font-mono">
        </div>
        
        <div class="space-y-1">
            <label class="text-[10px] font-mono tracking-wider font-bold uppercase text-coffee-milk block">Mật khẩu bảo mật</label>
            <input type="password" id="password" value="123456" required class="w-full text-xs px-4 py-2.5 bg-coffee-light border border-coffee-sand rounded-xl focus:outline-none focus:border-coffee-rust focus:bg-white transition-all font-mono">
        </div>
