...
-- Insert Members/CRM
INSERT INTO dbo.Members (phone, name, rank, points, email, pref, discount) VALUES
('0909123456', N'Trần Thị Thuỷ Tiên', 'Platinum', 740, 'thuytien@gmail.com', N'Espresso', N'Giảm 15% tổng hoá đơn'),
('0901234567', N'Lê Hoàng Phong', 'Gold', 320, 'hoangphong@gmail.com', N'Tea', N'Giảm 10% tổng hoá đơn'),
('0987654321', N'Nguyễn Minh Quân', 'Silver', 120, 'minhquan@gmail.com', N'Special', N'Giảm 5% tổng hoá đơn');
GO
